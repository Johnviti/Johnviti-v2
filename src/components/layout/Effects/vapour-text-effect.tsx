                ...
                case "fadingIn": {
                    ...
                    particlesRef.current.forEach(particle => {
                        ...
                        if (x >= 0 && x < width && y >= 0 && y < height) {
                            ...
                            data[index] = particle.color[0];
                            data[index + 1] = particle.color[1];
                            data[index + 2] = particle.color[2];
        ...
        for (let x = 0; x < canvas.width; x += sampleRate) {
            ...
            if (alpha > 0) {
                ...
                const particle = {
                    ...
                    originalX: x,
                    originalY: y,
                    color: [data[index], data[index + 1], data[index + 2], originalAlpha] as [number, number, number, number],
    ...
    particles.forEach(particle => {
        if (particle.opacity > 0) {
            ...
            if (x >= 0 && x < width && y >= 0 && y < height) {
                ...
                data[index] = particle.color[0];     // R
                data[index + 1] = particle.color[1]; // G
                data[index + 2] = particle.color[2]; // B
                data[index + 3] = Math.floor(particle.opacity * 255); // A
            }
        }
    });
